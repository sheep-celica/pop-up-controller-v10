...
- `testMotorCurrent` now samples at 1 ms intervals, reports timestamped 100 ms window extrema for plotting, and includes timestamped overall extrema in each motor summary.
